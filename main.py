...
for sym in symbols:
    try:
        ...
        # Lấy thông tin cơ bản (Vốn hóa, P/E)
        info = ticker.info
        market_cap_raw = info.get('marketCap', 0)
        market_cap = (market_cap_raw / 1000000000) if market_cap_raw else 0
        ...
        data_rows.append([
            ...
            round(pe, 1) if pe else "N/A", round(gtgd, 1)
        ])
        time.sleep(0.5) # Chờ 0.5s để Yahoo không chặn IP
    except Exception:
        continue
